...
public class Http11 extends RubyObject {
    ...
    public final static int MAX_QUERY_STRING_LENGTH = 1024 * 20;
    public final static String MAX_QUERY_STRING_LENGTH_ERR = "HTTP element QUERY_STRING is longer than the 20480 allowed length.";
